...
public class Workspace extends PagedView
    ...
    private static final String TAG = "Joy.Workspace";
	...
	public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShowText = res.getBoolean(R.bool.allow_show_hotseat_text);
    ...
    void addInScreen(View child, long container, int screen, int x, int y, int spanX, int spanY,
        ...
        if (container == LauncherSettings.Favorites.CONTAINER_HOTSEAT) {
            ...
            //delete by ming.huang at 2013-4-27 for show the text of hotseat icons
            ...
            //end
            /*
             * add "mLauncher.getIsVertical" to judge the orientation 
             * if is vertical show the icon text
             * is landscapes don't , for our icon is 57dp rather then 48dp original.
             * by yongjian.he on 20130624.
             */
            ...
            if (mLauncher.getIsVertical() && !mHideIconLabels) {
    ...
    boolean willCreateUserFolder(ItemInfo info, CellLayout target, int[] targetCell, float
        ...
        //modify by xiong.chen for bug WXY-24
