...
public class CellLayout extends ViewGroup {
    ...
    private Drawable mGlassBackground;
    private boolean isGlassWhenScroll;
    //add end
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mGlassBackground.setFilterBitmap(true);
        ...
        if (!LauncherApplication.isScreenLarge() && LauncherApplication.sTheme != LauncherApplication.THEME_IOS){
        ...
        //add by xiong.chen for bug wxy-512 at 2013-07-10
        isGlassWhenScroll = (PreferencesProvider.Interface.Homescreen.Scrolling.getTransitionEffect(
                res.getString(R.string.config_workspaceDefaultTransitionEffect)) == TransitionEffect.CubeOut);
    }
    ...
    */
    ...
    public static int[] rectToCell(Resources resources, int width, int height, int[] result) {
        ...
        //add by ming.huang at 2013-4-9.
        int otherSmallerSize = resources.getDimensionPixelSize(R.dimen.smaller_size);
        if(otherSmallerSize > 0)
        {
        	smallerSize = otherSmallerSize;
        }
        //end
