...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable,
    ...
    private static final String TAG = "Joy.AppsCustomizeTabHost";
    ...
    //add by xiong.chen for background transparent at 2013-05-10
    ...
    public AppsCustomizeTabHost(Context context, AttributeSet attrs) {
        ...
        mIsTransparent = mLauncher.isAppBackgroungTransparent();
        if (mIsTransparent) {
//            setBackgroundColor(Color.argb(76, 0, 0, 0));

            setBackgroundColor(context.getResources().getColor(R.color.appcustomize_app_backgrounds));
//            Log.e(TAG, "-------AppsCustomizeTabHost  color :  " + 
//            context.getResources().getColor(R.color.appcustomize_app_backgrounds) );
    ...
    protected void onFinishInflate() {
        ...
        //add by xiong.chen for background transparent at 2013-05-06
        if (mIsTransparent) {
            mAnimationBuffer.setBackgroundColor(Color.argb(0, 0, 0, 0));
        }
        //add end
    ...
    public void onTabChanged(String tabId) {
        ...
        if (!mAppsCustomizePane.isContentType(type) || mJoinWidgetsApps) {
            ...
            post(new Runnable() {
                ...
                onTabChangedStart();
                onTabChangedEnd(type);
                //Log.e(TAG, "---------onTabChanged: mIsTransparent " + mIsTransparent);
                //BEGIN : add for appsPane is transparent by yongjian.he
                if(mIsTransparent){
                	mAppsCustomizePane.setVisibility(View.INVISIBLE);
                	mAnimationBuffer.setVisibility(View.GONE);
                	mAnimationBuffer.removeAllViews();
                	mAppsCustomizePane.setVisibility(View.VISIBLE);
                }
                //END 20130626.
                ...
                //BEGIN : modify for appsPane is transparent by yongjian.he
                if(mIsTransparent){                	
                	animSet.playTogether(inAnim);
                }else{               	
